...
function InfoHoDan(props) {
  ...
  const handleRedirectCongCu = () => {
    navigation.navigate("ScreenCongCuHDThuocDL2", { idHodan: `${data._id}` });
  };
  const handleRedirectVatTu = () => {
    navigation.navigate("ScreenVatTuHDThuocDL2", { idHodan: `${data._id}` });
  };
  const handleRedirectNguyenLieu = () => {
    navigation.navigate("ScreenNguyenLieuHDThuocDL2", { idHodan: `${data._id}` });
  };
  const handleRedirectSanPham = () => {
    navigation.navigate("ScreenSanPhamHDThuocDL2", { idHodan: `${data._id}` });
  };
  const handleRedirectDonHang = () => {
    navigation.navigate("ScreenDonHangHDThuocDL2", { idHodan: `${data._id}` });
  };
